...
if [ "${1}" == "script" ]; then
    ...
    sleep 5
    git clone https://github.com/cloudwm/cloudcli.git -b v0.0.4
    cd cloudcli
    wget https://github.com/cloudwm/cloudcli/releases/download/v0.0.4/cloudcli-linux-amd64 -O cloudcli
